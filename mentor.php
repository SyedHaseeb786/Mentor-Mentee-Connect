...
<head>
    ...
    <style>
        ...
        .upload-marks-card::before { background-color: var(--primary-color); }
        .upload-marks-card .card-icon { color: var(--primary-color); }

        .track-progress-card::before { background-color: var(--success-color); }
        .track-progress-card .card-icon { color: var(--success-color); }

        .post-announcement-card::before { background-color: var(--warning-color); }
        .post-announcement-card .card-icon { color: var(--warning-color); }

        .parents-meeting-card::before { background-color: #6f42c1; }
        .parents-meeting-card .card-icon { color: #6f42c1; }

        .assignment-card::before { background-color: var(--accent-color); }
        .assignment-card .card-icon { color: var(--accent-color); }

        .contact-mentee-card::before { background-color: #28a745; }
        .contact-mentee-card .card-icon { color: #28a745; }
...
<body>
    <div class="dashboard-container">
        ...
        <div class="cards">
            <div class="card upload-marks-card" onclick="navigateTo('upload_marks.php.php')">
                <div class="card-icon">
